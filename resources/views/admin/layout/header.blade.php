            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown header-user">
                    <a href="#" data-toggle="dropdown" class="nav-link  nav-link-lg d-flex">
                        <span><img src="{{asset('storage/admin/'.@$admin->image)}}" alt="profile-user" class="rounded-circle w-32 mr-2"></span>
                        <span class=" mt-2 d-none d-lg-block ">
                            <span class="text-white"><span class="ml-1">{{@$admin->name}} </span></span>
                        </span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">

                        <div class=" dropdown-header noti-title text-center border-bottom pb-3">
                    <h5 class="text-capitalize text-dark mb-1">{{ @$admin->name }} </h5>
                        </div>

                        <a class="dropdown-item" href="{{route('dashboard.adminprofile')}} ">
