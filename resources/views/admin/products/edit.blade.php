                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <textarea name="description" id="editor" class="form-control" rows="3" required>{{$products->description}}</textarea>
                                        ...
                                        <div class="form-group mt-2">
                                            <label for="weight">Weight (In Number)</label>
                                            <input type="text" name="weight" class="form-control"
                                                value="{{$products->weight}}" required>
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <input type="text" name="country_of_origin" class="form-control"
                                                value="{{$products->country_of_origin}}" required>
                                        ...
                                        <div class="form-group mt-2">
                                                    ...
                                                    <div class="col-3" style="padding: 10px;">
                                                        <div class="position-relative">
                                                            <img style="width:100px; height:100px"
                                                                src="{{ asset('storage/product/' . @$images->images) }}"
                                                                width="100px">
                                                            <a href="{{ route('deleteSingleImage', $images->id) }}"
                                                                class="delete-image">
                                                                <button type="button"
                                            ...
                                            <div class="form-group mt-2" id="image-div">
                                                <label for="image">Image </label>
                                                <div class="row">
                                                    <input type="hidden" name="product_id"
                                                        value="{{ $products->id }}">
                                                    <input type="file" name="images[]" id="image"
                                                        class="form-control col-md-3" multiple>
                                                    <button id="btnImage" style="margin-left: 15px; border: none;"
                                                        class="fa fa-plus-circle fa-2x" type="button"></button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <input type="number" name="mrp" class="form-control" value="{{$products->mrp}}" required>
                                            @if ($errors->has('mrp'))
                                                <span class="required">
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <input type="number" name="sp" class="form-control" value="{{$products->sp}}" required>
                                            @if ($errors->has('sp'))
                                                <span class="required">
