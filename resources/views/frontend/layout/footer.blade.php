        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    ...
                    <a class="btn-link" href="{{route('contacts')}}">Contact Us</a>
                    <a class="btn-link" href="{{route('blog')}}">Blogs</a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    ...
                    <a class="btn-link" href="{{route('return')}}">Return Policy</a>
                    <a class="btn-link" href="{{route('myaccount')}}">My Account</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
