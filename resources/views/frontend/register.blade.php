            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-4">
                            <input type="text" class="w-100 form-control py-3" placeholder="Name"
                                name="Name" required>
                        </div>
                        ...
                        <div class="mb-4">
                            <input type="text" class="w-100 form-control py-3" placeholder="Enter Your Phone Number"
                                name="phone" required>
                        </div>
                        ...
                        <div class="mb-4">
                            <input type="Confirmpassword" class="w-100 form-control py-3" placeholder="Confirm your Password"
                                name="Confirm password" required>
                        </div>

                        <!-- Login Button -->
                        <div class="d-grid gap-2">
                            <button class="btn btn-primary py-3" type="submit">Register</button>
                        </div>

                        <!-- Forgot Password Link -->
                        <div class="text-center mt-3">
                            <a href="{{route('login')}}" class="text-muted">Aldready Registered ?</a>
                        </div>
                    </form>
                </div>
            </div>
