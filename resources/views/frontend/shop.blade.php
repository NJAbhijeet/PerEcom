                        ...
                        <div class="col-lg-3">
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    ...
                                    @php
                                        $categories = App\Models\Category::where('status', 'active')->take('2')->inRandomOrder()->get();
                                    @endphp
                                    <div class="mb-3">
                                        <h4>Categories</h4>
                                            ...
                                            @foreach ($categories as $cat)
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="{{route('product-by-category', $cat->slug)}}"><i class="fas fa-apple-alt me-2"></i>{{$cat->name}}</a>
                                                    </div>
                                                </li>
                                            @endforeach
                                        </ul>
                                    ...
                                    <div class="rounded position-relative fruite-item">
                                        <div class="fruite-img">
                                            <a href="{{route('shopdetail', $product->slug)}}">
                                                <img style="width:306px; height:191px" src="{{ asset('storage/product/' . $product->single_image->images) }}"
                                        ...
                                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                            ...
                                            <div class="d-flex justify-content-between flex-lg-wrap">
                                                <p class="text-dark fs-5 fw-bold mb-0">₹{{$product->sp}} / {{$product->units->name }} </p>
                                                <a href="#"
